...
function Header() {
    return (
        ...
        <nav class="bg-white border-b-2 border-gray-300 px-2 sm:px-4 py-2.5 rounded">
            <div class="container flex flex-wrap items-center justify-between mx-auto">
                <a href="#" class="flex items-center">
                    <span class="self-center text-xl font-semibold whitespace-nowrap">Real Estate App</span>
                </a>
